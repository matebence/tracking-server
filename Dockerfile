...
CMD ["./wait-for-it.sh" , "messaging-service:7400" , "--strict" , "--timeout=250" , "--" , "java", "-Dloader.path=tracking-server-0.0.1-SNAPSHOT-module.jar,tracking-server-0.0.1-SNAPSHOT-module.jar!/lib", "-Dspring.application.name=tracking-server", "-cp", "zipkin-server-2.12.3-exec.jar", "org.springframework.boot.loader.PropertiesLauncher", "--eureka.client.service-url.defaultZone=http://app-blesk-naming-server:b1477e9ba7723b8f47e9727a39a51edf@naming-server:8761/eureka", "--spring.security.user.name=app-blesk-tracking-server", "--spring.security.user.password=59fe09743cb9ef59276464f81734a003", "--spring.security.basic.enabled=true"]